...
**Interface 1** 128.174.240.0/20: **128.174.1111**0000.0/20, so $2^{12} - 2^{10} - 2^{10} - 2^{6} - 2^{3} = 1976$ address in total

**R1** 128.174.240.128/25: **128.174.240.1**0000000/25, so $2^{6} = 64$ addresses in total
